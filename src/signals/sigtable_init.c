 ...
 * @brief Implementations of functions to initialize t_shell_sigtable struct in sigtable.h
 */
...
int init_pa_sigtable(t_shell_sigtable* sigtable){
    ...
    INIT_SIG(sigtable, sigchld, sigchld_handler, SA_RESTART | SA_NOCLDSTOP, SIGCHLD);

 ...
 * @param term_ctrl pointer to t_term_ctrl struct
 *
 * This module sets current termios settings to raw mode, disabling ICANON and
 * ECHO flags
 *
...
/**
 * @brief saves terminal settings to cooked for ogl_terminal_settings, raw to
 * new_terminal_settings
 * @param term_ctrl pointer to t_term_ctrl struct
 *
 * This saves current terminal settings into ogl_terminal_settings for cooked
 * mode, saves raw terminal settings into new_terminal_settings for raw mode.
 *

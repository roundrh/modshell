 ...
 * @file executor.h
 *
 * This module declares the functions called by the driver to parse and execute accordingly.
 */

/**
 * @brief function parses cmd_buf to command then builds ast in shell struct and sends to executor.

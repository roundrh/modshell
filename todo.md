...
bugs:
kill -9 %$(echo 1):
%$ standalone string (echo 1) detected at wrong time in make_string []

implement:
[] Nested Param Expansion: only recurse for ${} and $(()) - no other expansion I have right now requires nested
